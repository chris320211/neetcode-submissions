class Solution:
    def isAnagram(self, s: str, t: str) -> bool:
        ...
        for letter in dictS: # iterate through keys
            if dictS[letter] != dictT.get(letter,0): # compare value (count) associated with key (letter)
                return False # if mismatch we return false
